<?php
/**
 * King Bee Std Boostrap functions and definitions
 *
 */

if ( ! function_exists( 'wp_king_bee_setup' ) ) :
/**
...
function wp_king_bee_setup() {
	 ...
	 */
	load_theme_textdomain( 'wp-king-bee', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'wp-king-bee' ),
	) );
...
add_action( 'after_setup_theme', 'wp_king_bee_setup' );
 ...
 */
function wp_king_bee_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wp_king_beer_content_width', 1170 );
}
add_action( 'after_setup_theme', 'wp_king_bee_content_width', 0 );
 ...
 */
function wp_king_bee_widgets_init() {
...
add_action( 'widgets_init', 'wp_king_bee_widgets_init' );
