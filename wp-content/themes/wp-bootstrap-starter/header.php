...
<body <?php body_class($class); ?>>
    <div id="page" class="site">
        ...
        <header id="masthead" class="site-header navbar-static-top ombre-bottom <?php echo wp_bootstrap_starter_bg_class(); ?>" role="banner">

            <div class="container-fluid ombre-bottom-light" id="topheader">
                <div class="container">
                    <div class="row">
            ...
            <div id="bandeau" class="container">
                <div class="row justify-content-between">
                    <div class="navbar-brand col-6 col-sm-4">
                    ...
                    <div class=" col-3 col-sm-4 mt-4">
                        <div class="float-right connexion py-1 py-sm-2  px-2 px-sm-3 ">
                            ...
                            if ( !is_user_logged_in() ) {
                                ...
                                echo '<div   class="d-none d-md-block"><a href="/inscription/" class=""><i class="far fa-user-plus mr-1"></i> S\'inscrire</a> | <a href="/demande-adhesion/" class=""><i class="far fa-user-plus mr-1"></i> Adhérer</a></div>';
                            }
                            ?>
            ...
            <div id="barrenavigation" class="container-fluid ombre-bottom <?php if(!is_front_page()) echo " fixed-header " ;?>">
                <div class="container">
