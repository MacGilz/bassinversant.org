...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    echo '<div class="evenement mb-2"><p> <i class="fas fa-calendar-check mr-2"></i>'. affiche_date_event(get_field('date_de_debut'),get_field('date_fin')).'</p></div>';
        ...
        <div class="entry-meta">
            ...
            <?php if (count(get_field( 'thematiques' ))>0 ):
echo '<div class="thematiques mt-1 mx-0 "> <strong><em>Thématiques : </em></strong>';
...
echo '</div>';
    ...
    <div class="row">
        ...
        <div class="source_actualite">
            <p>Source:
                <?php print_r($source) ; ?>
            </p>
            <?php print($source['0']['name']) ; ?>
        </div>
        <?php endif; ?>
 ...
 <?php if ( have_rows( 'fichiers_joints' ) ) {
    ...
    echo '<div class="fichiers-joints">
        ...
        while ( have_rows( 'fichiers_joints' ) ) {
            ...
            echo '<li><a href="'.$file['url'].'" class="">'.clean_fichier_title($file['title']).'</a></li>';
        }
