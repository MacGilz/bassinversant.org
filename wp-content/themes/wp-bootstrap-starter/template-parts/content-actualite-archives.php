<div class="items-actualites-<?php echo $format ?> col-12 col-md-6 d-flex flex-column pb-2 mb-3">
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class( 'dotted-bottom'); ?>>
        ...
        <header>
            ...
            if ( $format == 'archives' && $cat_actu == '' ) { //on n'affiche que si pas de categorie actus selectionnée dans le filtre 
                $categorie_actu = get_field( 'categorie_actu', get_the_ID() );
                echo '<div class="categorie-actu">Publié dans : <span>' . $categorie_actu->name . '</span></div>';
            }
